...
public class DisplayPastDayAppointments extends AppCompatActivity {
    ...
    int[] keys= {R.id.lv_past_date_booked,R.id.lv_past_hosp_name,
            R.id.lv_past_doc_name,R.id.lv_past_reason_visit};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView)findViewById(R.id.lv_past_day_appoint);
        try {

            getPastAppointmentsAsyncTask asyncTask = new getPastAppointmentsAsyncTask();
    ...
    public class getPastAppointmentsAsyncTask extends AsyncTask<String, String, Void> {
   ...
   /*     Calendar calendar = Calendar.getInstance();
        ...
        String ur_1= "http://13.127.188.57:8080/"+"rest_api/webapi/appointments/patient_past_appointments?patient_id="+patient_id+"&current_date="+today_date;

///patient_pastday_appointments?patient_id=1234&past_date=2017-12-31
        //  String[] doctors_name;

        public getPastAppointmentsAsyncTask() throws MalformedURLException {
            ...
            ur_1 = "http://13.127.188.57:8080/"+"rest_api/webapi/appointments/patient_past_appointments?patient_id="+patient_id+"&current_date="+today_date;
        }

        // HttpConnection connection;
        // HttpClient httpClient;

        private ProgressDialog progressDialog = new ProgressDialog(DisplayPastDayAppointments.this);
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                public void onCancel(DialogInterface arg0) {
                    getPastAppointmentsAsyncTask.this.cancel(true);
                }
            });
        }
                ...
                * */
                for (int i1 = 0; i1 < jArray.length(); i1++) {
                    ...
                    if(slot==1){
                        ...
                        slot_str = "8:30PM-10PM";
                    }
                    ///////
                    hm.put(ids[0], dateof_appointment.get(i1)+"\n"+slot_str);
                  //  hm.put(ids[0], "slot:"+slot_chosen_al.get(i1));
                 //   hm.put(ids[0], dateof_appointment.get(i1)+"\n"+"slot:"+slot_chosen_al.get(i1));
                ...
                SimpleAdapter sa = new SimpleAdapter(
                        DisplayPastDayAppointments.this, appointemnt_list_items, R.layout.list_item_view_past_day_appoint, ids, keys);
                lv.setAdapter(sa);

                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent i = new Intent(DisplayPastDayAppointments.this,PastPrescription.class);
                        i.putExtra("id",patient_id);
                        Log.e("doctor_id_sending......",doctors_id.get(position));
                        i.putExtra("doctor_id",doctors_id.get(position));
                        i.putExtra("url",prescription_url.get(position));
