...
public class DisplayCurrentDayAppointments extends AppCompatActivity {
    ...
    int[] keys= {R.id.lv_current_date_booked,R.id.lv_current_hosp_name,
            R.id.lv_current_doc_name,R.id.lv_current_reason_visit};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_current_day_appointments);
        patient_id = getIntent().getStringExtra("id");
        lv = (ListView)findViewById(R.id.lv_current_day_appoint);
        try {

            getCurrentAppointmentsAsyncTask asyncTask = new getCurrentAppointmentsAsyncTask();
    ...
    public class getCurrentAppointmentsAsyncTask extends AsyncTask<String, String, Void> {
   ...
   /*     Calendar calendar = Calendar.getInstance();
        ...
        ArrayList<NameValuePair> param = new ArrayList<NameValuePair>();
         ...
         String ur_1= "http://13.127.188.57:8080/"+"rest_api/webapi/appointments/patient_currentday_appointments?patient_id="+patient_id+"&current_date="+today_date;
        ;
///patient_currentday_appointments?patient_id=1234&current_date=2017-12-31
        //  String[] doctors_name;

        public getCurrentAppointmentsAsyncTask() throws MalformedURLException {
           // Log.e("ENCODING EXCEPTION", cur_date);
            ...
            ur_1 = "http://13.127.188.57:8080/"+"rest_api/webapi/appointments/patient_currentday_appointments?patient_id="+patient_id+"&current_date="+today_date;
        }

        // HttpConnection connection;
        // HttpClient httpClient;

        private ProgressDialog progressDialog = new ProgressDialog(DisplayCurrentDayAppointments.this);
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                public void onCancel(DialogInterface arg0) {
                    getCurrentAppointmentsAsyncTask.this.cancel(true);
                }
            });
        }
            ...
            R.id.lv_current_doc_name,R.id.lv_current_reason_visit};
                ...
                * */
                for (int i1 = 0; i1 < jArray.length(); i1++) {
                    ...
                    String slot_str = "";
                    if(slot==1){
                        slot_str = "10AM-11:00AM";
                    }
                    else if(slot==2){
                        slot_str = "11AM-12:00PM";
                    }
                    else if(slot==3){
                        slot_str = "1:30PM-3:30PM";
                    }
                    else if(slot==4){
                        slot_str = "3:30PM-5:00PM";
                    }
                    else if(slot==5){
                        slot_str = "5:30PM-7PM";
                    }
                ...
                SimpleAdapter sa = new SimpleAdapter(
                        DisplayCurrentDayAppointments.this, appointemnt_list_items, R.layout.list_item_view_current_day_appoint, ids, keys);
                lv.setAdapter(sa);
