...
import com.example.niharika.hospitalmanagementsystem.LocationUtil.PermissionUtils;
import com.example.niharika.hospitalmanagementsystem.LocationUtil.PermissionUtils.PermissionResultCallback;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancel = (Button)findViewById(R.id.cancelLocation);
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // showToast("Proceed to the next step");
                ...
                Intent i = new Intent(getApplicationContext(),RegisterActivity_3.class);
