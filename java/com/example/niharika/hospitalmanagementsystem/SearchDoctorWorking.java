...
public class SearchDoctorWorking extends AppCompatActivity {
...
// "specialization_id":"1","specialization_name":"ENT","gender":null,"year_join":2010}
    ...
    public class GetDoctorsAsyncTask extends AsyncTask<String, String, Void>{
      ...
      //  String[] doctors_name;
        ...
        private ProgressDialog progressDialog = new ProgressDialog(SearchDoctorWorking.this);
...
// "specialization_id":"1","specialization_name":"ENT","gender":null,"year_join":2010}
    ...
    ArrayList<Integer> doctors_years_exp= new ArrayList<Integer>();
               ...
               this.progressDialog.dismiss();
                ...
                SimpleAdapter sa = new SimpleAdapter(
                        SearchDoctorWorking.this,doctors_al, R.layout.viewdoctor_listitem, ids,keys);
                lv.setAdapter(sa);
                ...
                inputSearch.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                        ...
                        SimpleAdapter simple = new SimpleAdapter(SearchDoctorWorking.this, search_res, R.layout.viewdoctor_listitem,
                                ids,keys);
  ...
  /*  public class GetRatingsAsyncTask extends AsyncTask<String, String, Void>{


        ArrayList<NameValuePair> param = new ArrayList<NameValuePair>();

        final String ur_1 = "http://52.66.43.37:8080/FeedBackAPI/webapi/feedback/doctors";
        java.net.URL uri = new URL(ur_1);
        //  String[] doctors_name;

        public GetRatingsAsyncTask() throws MalformedURLException {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                public void onCancel(DialogInterface arg0) {
                    GetRatingsAsyncTask.this.cancel(true);
                }
            });
