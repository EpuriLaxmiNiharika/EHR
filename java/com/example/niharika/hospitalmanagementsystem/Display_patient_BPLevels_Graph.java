...
public class Display_patient_BPLevels_Graph extends AppCompatActivity {


    LineChart linechart;
    String pat_id ="";

    ArrayList<Integer> bp_level = new ArrayList<Integer>();
    ArrayList<String>app_date = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_patient__bplevels__graph);

        pat_id = getIntent().getStringExtra("id");
    /*    GraphView graphView = (GraphView)findViewById(R.id.displayBlood PressurelevelGraph);
    ...
    private ArrayList<Entry> setYAxisValues(ArrayList<Integer> bps){
        ArrayList<Entry> yVals = new ArrayList<Entry>();

        for(int i = 0; i<bps.size();i++){
            yVals.add(new Entry(bps.get(i), i));
        }
        return yVals;
    }

    private void setData(ArrayList<Integer> bps, ArrayList<String> app_date) {
        ArrayList<String> xVals = setXAxisValues(app_date);

        ArrayList<Entry> yVals = setYAxisValues(bps);

        LineDataSet set1;

        // create a dataset and give it a type
        set1 = new LineDataSet(yVals, "Variations of Blood Pressure levels");
    ...
    public class GetBPLevelAsyncTask extends AsyncTask<String, String, Void> {
        ...
        private ProgressDialog progressDialog = new ProgressDialog(Display_patient_BPLevels_Graph.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                for(i=0; i < jArray.length(); i++) {
                    ...
                    int bp_level_ = jObject.getInt("bloodPressure");

                    String date = jObject.getString("date");


                    bp_level.add(bp_level_);

                    Log.e("Bp level",bp_level_+"");
                ...
                linechart = (LineChart) findViewById(R.id.line_chart_bp_level);
                ...
                // no description text
                linechart.setDescription("BPlevels variation");
